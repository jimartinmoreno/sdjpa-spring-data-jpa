...
public class BookRepositoryTest {
    ...
    void testBookStream() {
        ...
        assertThat(bookRepository.findAllByTitleNotNull().count()).isGreaterThanOrEqualTo(5);
    }

    @Test
    void testFindBookByTitle() {
        Optional<Book> book1 = bookRepository.findBookByTitle("Clean Code");
        assertNotNull(book1);
        assertNotNull(book1.get());

        Optional<Book> book2 = bookRepository.findBookByTitle("XXXX");
        assertNotNull(book2);
        assertEquals(true, book2.isEmpty());
    }
